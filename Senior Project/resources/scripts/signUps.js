...
function saveEvent() {
    ...
    console.log(JSON.stringify({ proposal_name: newEventName, cost_to_attendee: newEventPrice, description: newEventDescription, event_signup_close: newEventSignUpCloseDate }));
    xhr.send(JSON.stringify({ proposal_name: newEventName, cost_to_attendee: newEventPrice, description: newEventDescription, event_signup_close: newEventSignUpCloseDate }));
    return xhr;
